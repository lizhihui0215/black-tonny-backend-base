...
async def create_redis_cache_pool() -> None:
    ...
    cache.client = redis.Redis.from_pool(cache.pool)  # type: ignore[assignment]
...
def create_application(
    ...
    **kwargs
    ...
    based on the provided settings. It includes setting up Redis cache pools, client-side caching,
